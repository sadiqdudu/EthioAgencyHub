...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page { max-width: 800px; margin: 0 auto; background: #fff; padding: 50px; box-shadow: ${isMinimal ? 'none' : '0 10px 25px rgba(0,0,0,0.05)'}; border-radius: ${isMinimal ? '0' : '16px'}; border: ${isMinimal ? '1px solid #eaeaea' : 'none'}; }
    .header { text-align: ${isModern ? 'left' : 'center'}; margin-bottom: 40px; border-bottom: ${isModern ? '4px solid var(--primary)' : '1px solid #eaeaea'}; padding-bottom: 20px; }
    ...
    .section-title { font-size: 18px; font-weight: bold; color: var(--primary); border-bottom: 2px solid #f1f5f9; padding-bottom: 8px; margin-bottom: 20px; display: flex; align-items: center; gap: 10px; }
    ...
    .footer { margin-top: 50px; text-align: center; font-size: 12px; color: #cbd5e1; }
  </style>
</head>
<body>
  <div class="page">
    ...
    <div class="section">
      ...
      <div class="grid">
        <div class="card">
          <div class="item-label">Experience</div>
    ...
    <div class="section">
      <div class="section-title">System Records</div>
      <div class="grid">
        <div class="card">
          <div class="item-label">Documents on File</div>
          <div class="item-value">${employee.documents?.length || employee._count?.documents || 0} Verified Documents</div>
        </div>
        <div class="card">
          <div class="item-label">Travel History</div>
    ...
    <div class="footer">
      Generated securely by Ethio Agency Hub
    </div>
  </div>
</body>
</html>
